...
(function(resourcesUrl){!function(n){const i=window,o=i.Ionic;if(!o||!o.config||"Object"===o.config.constructor.name)return i.Ionic=i.Ionic||{},i.Ionic.config=Object.assign({},i.Ionic.config,{mode:"md"}),i.Ionic.config;console.error("ionic config was already initialized")}();
})(resourcesUrl);
